...
//static uint8_t RSP_GATT_GET_GAP_SVC[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x07,0x10,0x00,0x10,0x00};
...
//static uint8_t RSP_GATT_GET_GATT_SVC[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x07,0x20,0x00,0x20,0x00};
...
//static uint8_t RSP_GATT_GET_SCAN_SVC[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x07,0x30,0x00,0x30,0x00};
...
static uint8_t RSP_GATT_GET_DEVI_SVC[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x01,0x06,0x01,0x00,0x0a};
...
static uint8_t RSP_GATT_GET_BATT[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x07,0x10,0x00,0x12,0x00};
static uint8_t RECV_GATT_GET_BATT_CHAR[] = {0x02,XXXX,XXXX,0x0b,0x00,0x07,0x00,0x04,0x00,0x08,0x10,0x00,0x12,0x00,0x03,0x28};
static uint8_t RSP_GATT_GET_BATT_CHAR[] = {0x02,XXXX,XXXX,0x0d,0x00,0x09,0x00,0x04,0x00,0x09,0x07,0x11,0x00,0x02,0x12,0x00,0x19,0x2a};
static uint8_t RECV_GATT_GET_BATT_LEVEL[] = {0x02,XXXX,XXXX,0x07,0x00,0x03,0x00,0x04,0x00,0x0a,0x12,0x00};
...
static uint8_t RECV_GATT_FIND_BY_TYPE[] = {0x02,XXXX,XXXX,0x0d,0x00,0x09,0x00,0x04,0x00,0x06,XXXX,XXXX,XXXX,XXXX,XXXX,XXXX};
static uint8_t RSP_GATT_FIND_BY_TYPE_ERR[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x01,0x06,0x10,0x00,0x0a};
...
static void bt_recv_cb(char *d, int len)
{
	...
	IF(RECV_LE_CONNECTED_TOUT){ if(iat != 0xFF)SEND(LE_SET_ADV_ENABLE);}
	...
	IF(RECV_GATT_FIND_BY_TYPE){
		SET_HANDLE(RSP_GATT_FIND_BY_TYPE_ERR, 1);
		RSP_GATT_FIND_BY_TYPE_ERR[11] = d[10];
		RSP_GATT_FIND_BY_TYPE_ERR[12] = d[11];
		SEND(RSP_GATT_FIND_BY_TYPE_ERR);
	}
