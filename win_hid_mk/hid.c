...
static uint8_t LE_SET_ADV_PARAM[] = {0x01,0x06,0x20,0x0f,0x20,0x00,0x28,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0x00};
...
static uint8_t RSP_SMP_PAIRING[] = {0x02,0x40,0x20,0x0b,0x00,0x07,0x00,0x06,0x00,0x02,0x03,0x00,0x01,0x10,0x01,0x01};
...
static uint8_t RECV_GATT_GET_GATT[] = {0x02,XXXX,XXXX,0x0D,0x00,0x09,0x00,0x04,0x00,0x06,0x01,0x00,0xFF,0xFF,0x00,0x28,0x01,0x18};
static uint8_t RSP_GATT_GET_GATT[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x01,0x06,0x10,0x00,0x0a};
static uint8_t RECV_GATT_GET_GAP[] = {0x02,XXXX,XXXX,0x0D,0x00,0x09,0x00,0x04,0x00,0x06,0x01,0x00,0xFF,0xFF,0x00,0x28,0x00,0x18};
static uint8_t RSP_GATT_GET_GAP[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x01,0x06,0x20,0x00,0x0a};
static uint8_t RECV_GATT_GET_SCAN[] = {0x02,XXXX,XXXX,0x0D,0x00,0x09,0x00,0x04,0x00,0x06,XXXX,XXXX,XXXX,XXXX,0x00,0x28,0x13,0x18};
static uint8_t RSP_GATT_GET_SCAN[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x01,0x06,0x01,0x00,0x0a};
static uint8_t RECV_GATT_GET_DEVI[] = {0x02,XXXX,XXXX,0x0D,0x00,0x09,0x00,0x04,0x00,0x06,XXXX,XXXX,XXXX,XXXX,0x00,0x28,0x0a,0x18};
static uint8_t RSP_GATT_GET_DEVI[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x01,0x06,0x01,0x00,0x0a};
static uint8_t RECV_GATT_GET_BATT[] = {0x02,XXXX,XXXX,0x0D,0x00,0x09,0x00,0x04,0x00,0x06,XXXX,XXXX,XXXX,XXXX,0x00,0x28,0x0f,0x18};
static uint8_t RSP_GATT_GET_BATT[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x01,0x06,0x01,0x00,0x0a};
static uint8_t RECV_GATT_GET_GAP_CHAR[] = {0x02,XXXX,XXXX,0x0b,0x00,0x07,0x00,0x04,0x00,0x08,0x10,0x00,0x12,0x00,0x03,0x28};
static uint8_t RSP_GATT_GET_GAP_CHAR[] = {0x02,XXXX,XXXX,0x0d,0x00,0x09,0x00,0x04,0x00,0x09,0x07,0x11,0x00,0x02,0x12,0x00,0x00,0x2a};

static uint8_t RECV_GATT_GET_GATT_CHAR[] = {0x02,XXXX,XXXX,0x0b,0x00,0x07,0x00,0x04,0x00,0x08,XXXX,0x00,0x22,0x00,0x03,0x28};
static uint8_t RSP_GATT_GET_GATT_CHAR[] = {0x02,XXXX,XXXX,0x0d,0x00,0x09,0x00,0x04,0x00,0x09,0x07,0x21,0x00,0x02,0x22,0x00,0x05,0x2a};
static uint8_t RECV_GATT_GET_OTHER_CHAR[] = {0x02,XXXX,XXXX,0x0b,0x00,0x07,0x00,0x04,0x00,0x08,XXXX,XXXX,XXXX,XXXX,0x03,0x28};
static uint8_t RSP_GATT_GET_OTHER_CHAR[] = {0x02,XXXX,XXXX,0x09,0x00,0x05,0x00,0x04,0x00,0x01,0x08,0x10,0x00,0x0a};
...
static void bt_recv_cb(char *d, int len)
{
	...
	// Service not exist
	}IF(RECV_GATT_GET_GATT){
		SET_HANDLE(RSP_GATT_GET_GATT, 1);
		SEND(RSP_GATT_GET_GATT);
	}IF(RECV_GATT_GET_GAP){
		SET_HANDLE(RSP_GATT_GET_GAP, 1);
		SEND(RSP_GATT_GET_GAP);
	}IF(RECV_GATT_GET_SCAN){
		SET_HANDLE(RSP_GATT_GET_SCAN, 1);
		SEND(RSP_GATT_GET_SCAN);
	}IF(RECV_GATT_GET_DEVI){
		SET_HANDLE(RSP_GATT_GET_DEVI, 1);
		SEND(RSP_GATT_GET_DEVI);
